...
PROJECT_REPO ?= github.com/angelokurtis/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-github_v6.5.0
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/githubs/03-delete.yaml.tmpl.
